...
This is the reposity of the final project made for the exam of **Interactive graphics**, made by Luca Adamo, student ID 1987858. 
...
* **Hard:** This case begins already with one ball, with more or less the same progressive updates as the other difficulties, but with the ball smaller than before and that starts already faster.
...
### Arm controls
* `Left Arrow` / `Right Arrow`: Rotate the robot's **base** in the horizontal plane.
* `Up Arrow` / `Down Arrow`: Control the tilt of the **lower arm**.
* `W` / `S`: Control the tilt of the **upper arm**.
